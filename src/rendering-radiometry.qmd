...
A **radiometer** is a device that measures the absolute radiometric quantities (e.g., spectral power distribution) of emissive sources, such as a light bulb.
Of course, what a radiometer actually obtains the necessarily photometric quantities, but as long as we know the spectral sensitivities of the detector, we can calculate the radiometric quantities.
Very confusingly, a **photometer** is *not* a device that measures photometric quantities (any device necessarily measures photometric quantities); instead, it is a device that measures material reflectance.
See @sec-chpt-mat-rt-ref for a more detailed discussion.
