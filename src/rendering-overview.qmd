...
Famously, it does not explain how the interference pattern in the double-slit experiment still arises even if the photons are delivered sequentially, nor does it explain why the interference pattern goes away if we put a detector on the other side.].
...
Here we have assumed a perfectly specular reflection and refraction that obey the Snell’s law (@sec-chpt-mat-ss-mat), where, for instance, the direction of reflection is mirror-symmetric to the incident direction.
