...
The perspective I most want to offer is this: every conclusion is drawn based on a set of precisely defined terms and assumptions, which, unfortunately, are not always explicitly spelt out.
...
The same author is developing another book [@wandell2026foundations] that covers not only human vision, but also imaging and display --- a similar set of topics covered in this book.
It is interesting to see how different people sometimes can approach similar topics from quite different angles.
