...
Fechner hypothesized that there is some sort of internal neural response that governs our perception of signal strength.
That relationship between the perceived signal strength (e.g., light brightness) and the physical signal strength (e.g., light intensity) is governed by a logarithmic relationship:

$$
    p(I) = \ln(I) + C,
$$ {#eq-fechner1}

where $I$ is the current signal strength, and $p$ is the perceived strength under $I$.
...
We need two more assumptions. First, humans require a minimal $\Delta p(I)$ for $I$ to be behaviorally detectable and  $\Delta p(I)$ is a constant regardless of $I$.
Second, $\Delta p(I)$ is sufficiently small that we can treat it as infinitesimal (equivalent to $\text{d}p(I)$).
Therefore, we have:
